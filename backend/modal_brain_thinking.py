"""Modal chat worker: E4B with Gemma 4 thinking (reasoning parser).

Second app next to `modal_brain.py` (default E4B, no parser). Do not add
...
Set VLLM_THINKING_BASE_URL to the printed URL plus /v1. Leave VLLM_BASE_URL
on the default E4B worker. Gemma 4 is gated: same Modal secret `huggingface`.
"""
...
app = modal.App("agentic-video-brain-e4b-thinking")
