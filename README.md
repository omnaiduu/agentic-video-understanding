...
**If you are a human:** start at **[HUMAN-backend.md](HUMAN-backend.md)** (picture) then **[HUMAN-data.md](HUMAN-data.md)** (what we save and send). The numbered `docs/` files are for coding agents.
