...
This repository is the **design, decisions, and conversation record**, plus **Phases 1–10** of the app (`backend/` through memory, `web/` library, upload, and live index panel). Player and chat UI are not in this slice.
