...
**Open (not locked):** **E4B** + **clipboard + verb menu** instead of a 12B tool-calling agent — [15](15-workflows-vs-agents.md), [16](16-clipboard-and-verbs.md). Plain map: [17-plain-map.md](17-plain-map.md).
