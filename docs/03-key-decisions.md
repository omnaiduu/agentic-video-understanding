...
**Open (not locked):** **E4B** + **clipboard + verb menu** instead of a 12B tool-calling agent — [15-workflows-vs-agents.md](15-workflows-vs-agents.md), [16-clipboard-and-verbs.md](16-clipboard-and-verbs.md).
