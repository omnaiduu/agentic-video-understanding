...
8. [Frontend and backend](08-frontend-backend.md)
...
15. [Gemma as indexer](15-gemma-as-indexer.md) — discussion: find vs answer, vectors vs four drawers (**not v1**)
16. [Phase 1](phases/phase-01.md) — hold a video (**locked**)
17. [Phase 2](phases/phase-02.md) — scissors (**locked**)
18. [Phase 3](phases/phase-03.md) — brain loop (**locked**)
19. [Phase 4](phases/phase-04.md) — speech phone book (**locked**)
20. [Phase 5](phases/phase-05.md) — picture phone book (**locked**)
21. [Phase 6](phases/phase-06.md) — sound phone book (**locked**)
22. [Phase 7](phases/phase-07.md) — export a clip (**locked**)
23. [Phase 8](phases/phase-08.md) — remember last times (**locked**)
24. [Phase 9](phases/phase-09.md) — website shell (**locked**; TanStack Start)
25. [Phase 10](phases/phase-10.md) — upload in the browser + **live index status** (**locked**)
26. [Phase 11](phases/phase-11.md) — watch and ask (**locked**; Video.js)
27. [Phase 12](phases/phase-12.md) — clips and polish (**locked**)
28. [Phase 13](phases/phase-13.md) — slide phone book (**locked**; ColQwen2.x + `search_slides`)
