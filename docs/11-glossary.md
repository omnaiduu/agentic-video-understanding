...
| **System One / Jev (closed)** | Typed closed-set decisions (Choice / Score / yes-no). We tried letter logprobs for first-hop search. **Reverted.** [system-one-picker.md](system-one-picker.md). |
